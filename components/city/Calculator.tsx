  ...
  return (
    <section id="calculator" className="scroll-mt-[120px] max-w-6xl mx-auto px-6 pt-14 md:pt-20">
      ...
      <div className="rounded-3xl bg-surface border hairline p-6 md:p-8 overflow-hidden">
        ...
        {/* min-h — карточка-замок центрируется поверх этого блока через
            absolute inset-0; если реальных строк мало (например всего
            1-2 статьи расхода), блок ниже естественной высоты карточки —
            карточка тогда вылезает за его границы и наезжает на «Итого»
            снизу (найдено вживую 2026-09-10). Гарантируем блоку высоту не
            меньше карточки замка. */}
