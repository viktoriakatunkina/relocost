  ...
  return (
    <section className="max-w-4xl mx-auto px-6 pt-14 md:pt-20 overflow-x-hidden">
      ...
      <div className="rounded-3xl bg-surface border hairline p-6 md:p-9">
        ...
        {/* Разводим с квизом подбора: это объективная оценка города по
            фиксированным критериям (одинаковая для всех), а не персональный
            подбор под приоритеты конкретного человека — их считают по-разному
            и не должны совпадать. */}
        <p className="mt-3 text-xs text-brandy/40 text-pretty">
          Это общая объективная оценка города — одна для всех. Если хотите
          подобрать город под свои приоритеты (бюджет, климат, море,
          безопасность), используйте{" "}
          <Link href="/match" className="text-brandy/60 hover:text-copper hover:underline">
            подбор «Куда переехать»
          </Link>{" "}
          — там результат зависит от того, что важно именно Вам.
        </p>
      </div>
    </section>
  );
