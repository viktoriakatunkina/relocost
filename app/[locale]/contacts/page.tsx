        ...
        <div className="rounded-2xl bg-surface border hairline p-6 md:p-8">
          ...
          <dl className="space-y-5 text-brandy/85 leading-relaxed">
            <div>
              ...
              <dd>
                Доступ к платным информационным разделам сайта relocost.ru. Для
                страниц городов: «Лучшие места для посещения» (19 ₽), «Полный
                список статей расходов» (49 ₽) и комбо «Расходы + Лучшие места»
                (59 ₽). Для страниц стран: «Рейтинг городов страны» (49 ₽) и
                «Полный обзор страны» (29 ₽). Цены окончательные, в рублях, НДС
                не облагаются (режим НПД).
              </dd>
            </div>
            <div>
