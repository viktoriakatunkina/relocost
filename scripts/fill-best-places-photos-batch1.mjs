...
const CITY_QUERIES = {
  budapest: [
    ["VII район (Erzsébetváros)", "Erzsebetvaros Budapest ruin bar district"],
    ...
    ["Лангош у рынка", "Langos Budapest street food"],
    ["Дунайская набережная и Парламент", "Danube promenade Parliament Budapest"],
  ],
  kutaisi: [
    ["Храм Баграта", "Bagrati Cathedral Kutaisi"],
    ["Аэропорт Кутаиси", "Kutaisi International Airport"],
    ["Pheasant's Tears", "Pheasant's Tears restaurant Georgia"],
...
async function run() {
  ...
  fs.writeFileSync(
    "/private/tmp/claude-501/-Users-viktoriadimark/7cc9059d-467f-41f1-b2ea-ed28c09919f9/scratchpad/batch1-results.json",
