...
const NEW_SLUGS = [
  // 591
  'slovakiya-bratislava-pereezd-dn-2026',
  'abkhaziya-sukhum-pereezd-2026',
  'minimalny-byudzhet-pereezda-za-rubezh-2026',
  // 592
  'greciya-thessaloniki-pereezd-2026',
  'top-stran-dlya-pereezda-roditelyami-2026',
  'kak-ustroitsya-v-novoy-strane-za-90-dney-2026',
];
...
console.log('\nIndexNow батчей 591-592 готово.');
