...
const NEW_SLUGS = [
  // 599
  'kiplr-nikosiya-pereezd-dn-2026',
  'top-stran-dlya-pensionerov-pereezd-2026',
  'kolumbiya-medellin-pereezd-dn-2026',
  // 600
  'top-stran-dlya-pereezda-it-spetsialistov-2026',
  'indiya-goa-pereezd-dn-dlitelno-2026',
];
...
console.log('\nIndexNow батчей 599-600 готово.');
