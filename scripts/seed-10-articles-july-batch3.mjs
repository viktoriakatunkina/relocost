// Батч july-batch3: 10 SEO-статей — Сербия (банк, ВНЖ), Подгорица, Пхукет vs Чиангмай,
// пенсия за рубеж, Кипр, Бали, квартира из-за рубежа, Финляндия, Грузия дёшево.
// Запуск: node scripts/seed-10-articles-july-batch3.mjs
...
const SLUGS = [
  "kak-otkryt-schet-v-banke-serbii-2026",
  "stoimost-zhizni-v-podgorice-2026",
  "kak-poluchit-vnzh-v-serbii-2026",
  "phuket-ili-chiang-mai-2026",
  "kak-perevesti-pensiu-za-rubezh",
  "pereezd-v-kipr-2026",
  "bali-dlya-pereezda-2026",
  "kak-sdat-kvartiru-v-moskve-nahodyas-za-rubezhom",
  "finlyandiya-dlya-rossiyan-zhizn-2026",
  "zhizn-v-gruzii-bez-deneg-minimalnyj-budzhet",
];

const META = {
  "kak-otkryt-schet-v-banke-serbii-2026": {
    unsplash_query: "belgrade serbia bank city street architecture",
    country_slug: "serbia",
    city_slug: "belgrade",
    tag: "Документы",
  },
  "stoimost-zhizni-v-podgorice-2026": {
    unsplash_query: "podgorica montenegro city landscape mountains",
    country_slug: "montenegro",
    city_slug: "podgorica",
    tag: "Стоимость жизни",
  },
  "kak-poluchit-vnzh-v-serbii-2026": {
    unsplash_query: "serbia belgrade old town architecture permit document",
    country_slug: "serbia",
    city_slug: "belgrade",
    tag: "Документы",
  },
  "phuket-ili-chiang-mai-2026": {
    unsplash_query: "chiang mai thailand temple mountains city",
    country_slug: "thailand",
    city_slug: null,
    tag: "Сравнения",
  },
  "kak-perevesti-pensiu-za-rubezh": {
    unsplash_query: "retirement pension senior couple abroad travel lifestyle",
    country_slug: null,
    city_slug: null,
    tag: "Финансы",
  },
  "pereezd-v-kipr-2026": {
    unsplash_query: "limassol cyprus mediterranean sea coast cityscape",
    country_slug: "cyprus",
    city_slug: "limassol",
    tag: "Страны",
  },
  "bali-dlya-pereezda-2026": {
    unsplash_query: "bali indonesia rice terraces canggu beach sunset",
    country_slug: "indonesia",
    city_slug: "bali",
    tag: "Страны",
  },
  "kak-sdat-kvartiru-v-moskve-nahodyas-za-rubezhom": {
    unsplash_query: "moscow russia apartment building city rental property",
    country_slug: null,
    city_slug: null,
    tag: "Финансы",
  },
  "finlyandiya-dlya-rossiyan-zhizn-2026": {
    unsplash_query: "helsinki finland city waterfront architecture winter",
    country_slug: "finland",
    city_slug: "helsinki",
    tag: "Страны",
  },
  "zhizn-v-gruzii-bez-deneg-minimalnyj-budzhet": {
    unsplash_query: "tbilisi georgia old town bridge colorful balconies",
